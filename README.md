...
![version](https://img.shields.io/badge/version-v0.4.0-blue) ![platform](https://img.shields.io/badge/platform-Windows-informational)
...
| 功能 | 說明 |
| --- | --- |
| **多工作區** | 左側工作區列（可顯示/隱藏）切換專案；可加入既有資料夾，或透過 HTTPS／SSH Clone Git Repository 後直接開啟；每個工作區獨立狀態。 |
...
2. **雙擊直接執行**——免安裝、不寫入系統。
3. 左上「＋」可新增既有工作區或 Clone Git Repository；完成後即可開終端機、編輯檔案、跑 Git、看 AI 狀態。
