...
export const RELEASE_NOTES: ReleaseNote[] = [
  ...
  },
  {
    ...
    date: '2026-08-10',
    highlights: [
      '檔案總管、搜尋、原始碼控制與設定移到工作區標頭，移除最左側固定活動列以增加可用空間',
      '首次啟動提供 7 步操作導覽；之後可從「說明」或設定重新開啟導覽與可搜尋的完整使用指南',
      '冷啟動顯示輕量開啟畫面，等待工作區載入且 renderer 可操作後才交接主視窗，失敗時可重試或退出',
      '編輯器與終端機顯隱仍保留側欄尺寸，終端機內容／對話導覽軸維持完整移除',
    ],
  },
  {
    version: '0.26.0',
